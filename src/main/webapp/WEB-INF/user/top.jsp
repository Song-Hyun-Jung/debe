...
<style>
	...
	.menuhover:hover {background-color:#a9173d;}
</style>
</head>
<body>
		<table id="topLayout">
		...
		<nav>
			<table id="menu">
				<tr>
					<td width="30%"></td>
					<td class="menuhover"><a href="question.html" id="menu_string">질문하기</a></td>
					<td width="11%"></td>
					<td class="menuhover"><a href="qanda.html" id="menu_string">Q&A</a></td>
					<td width="11%"></td>
